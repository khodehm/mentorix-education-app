...
const Features = () => {
   const fileds = [
    ...
    return (
        <>
        <motion.article initial={{opacity:0}} animate={{opacity:1 , animation:"ease-in-out"}} className="relative h-screen p-4  py-4 text-center ">
        ...
        <section className="relative z-auto flex flex-col  lg:h-[90%] sm:h-[80%] bg-bg2 rounded-lg  mb-4 ">
