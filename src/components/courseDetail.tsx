    ...
    <>
      <motion.section variants={varients} initial="hidden" animate="visible" className="relative flex flex-col w-full h-screen">
        ...
        <div className="flex flex-col items-start text-balance">
            ...
            <div className=" relative top-32 w-full"><button className={`flex justify-center p-3 rounded-xl w-full text-lg font-bold text-white `} style={{background:course.btn}}>برو بریم !</button></div>
        </div>
        </section>
      </motion.section>
    </>
