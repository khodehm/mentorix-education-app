    ...
    return(
        ...
        <>
            <Swiper initialSlide={activeIndex} 
             onSlideChange={handleChange} slidesPerView={1} spaceBetween={100} direction="vertical" modules={[Mousewheel]} mousewheel={{ forceToAxis: true, releaseOnEdges: true ,sensitivity:1000 ,thresholdTime:1000 }} speed={800} className="h-screen w-screen">
              {routes.map((route) => (
